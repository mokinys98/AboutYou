...
| 5 | [Produkcinis cutover](5-produkcijos-perjungimas.md) | Vykdomas: Pages ir Worker perjungti į VPS, cutover preflight `18/18 PASS`, cron’ai atkurti, metadata 50/50 canary ir operatoriaus UI smoke sėkmingi; vyksta pilnas katalogo sync, liko finalus checkpoint |
