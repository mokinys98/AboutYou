...
| 4 | [Pages, Worker ir produkcinio perjungimo rehearsal](4-produkciniu-integraciju-perjungimo-rehearsal.md) | Raw payload read patikrintas; production cutover dar STOP dėl `.env` sintaksės, Auth/JWKS, Pages preview, backup/monitoring ir rollback vartų |
