-- Exclude equality from both price-comparison filters.
-- Existing databases need a new migration; editing older migrations does not
-- change already-applied schema objects.
