-- 20260921122000 initially used last_success_at to rate-limit new cycles.
-- A blocked or partial cycle does not update that timestamp, so it could start a
-- fresh cycle every 15 minutes. Rate-limit by the most recent cycle instead.
